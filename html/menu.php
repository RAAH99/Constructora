...
<div class="container-fluid contenedor " ><!---->
  <div class="row">
    <div class="col-sm-2" ><p class="texto">
     <a href="PrestamoHerramientas.php"> <img src="../imagenes/Prestamo.jpg" class="opciones" ></a><br>Prestamo de herramientas</p>
      <p class="texto"><a href="DevolucionHerramientas.php"> <img src="../imagenes/entrega.png" class="opciones" ></a><br>Devolucion de herramientas</p>
      <p class="texto"><a href="InventariodeHerramientas.php"> <img src="../imagenes/Inventario.png" class="opciones2" ></a><br>Inventario de herramientas</p>
...
<?php
  ...
  if ($_SESSION["usuario"]["nivel"]=='Administrador') {
    print "<label style='color:white;'>Bienvenido ". $_SESSION['usuario']["nombre"]."(".$_SESSION["usuario"]['nivel'].").</label>";
